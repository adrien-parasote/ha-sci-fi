/**
 * landspeeder-svg.ts — the landspeeder top-view illustration.
 *
 * A 412-line static asset, extracted from sf-landspeeder._renderSpeeder() by
 * ADR-017 step 5. It has no interpolation and no dependency on component state,
 * so it is an asset, not logic — keeping it inline made _renderSpeeder the
 * longest function in the codebase and pushed the file past any readable size.
 *
 * Ported 1:1 from main:src/components/landspeeder/data/top.js.
 */

import { html, type TemplateResult } from 'lit';

export const LANDSPEEDER_SVG: TemplateResult = html`
