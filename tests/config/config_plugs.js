    ...
    },
    {
      ...
      sensors: {
        'number.nous_paillette_charlotte_countdown': {
          show: false,
          name: 'Nous Paillette Charlotte Countdown',
          power: false,
        },
        'select.nous_paillette_charlotte_power_outage_memory': {
          show: false,
          name: 'Nous Paillette Charlotte Power outage memory',
          icon: 'mdi:power-settings',
          power: false,
        },
        'select.nous_paillette_charlotte_indicator_mode': {
          show: false,
          name: 'Nous Paillette Charlotte Indicator mode',
          power: false,
        },
        ...
        'sensor.nous_paillette_charlotte_energy': {
          show: false,
          name: 'Nous Paillette Charlotte Énergie',
          power: false,
        },
        'lock.nous_paillette_charlotte_child_lock': {
          show: false,
          name: 'Nous Paillette Charlotte Child lock',
          power: false,
        },
