# .agents/learnings.md — Pattern & Anti-Pattern Registry

> Last updated: 2026-06-02 | Entries: 90 | Total originally: 96 → 88 after dedup + cleanup

## Index

| L# | Title | Type | Tags | Date |
|---|---|---|---|---|
| L012 | Spec Conformance Exclusions for External Domain Entities | pattern | release, methodology, ha-api, typescript | 2026-05-23 |
| L013 | Post-Refactor TDD Lock Re-alignment | pattern | testing, release, methodology, typescript | 2026-05-23 |
| L014 | Vitest & Lit Element Lifecycle Warnings | pattern | lit, testing, release, methodology | 2026-05-23 |
| L015 | Happy-DOM and Canvas APIs (Chart.js) | pattern | testing, release, methodology | 2026-05-23 |
| L016 | Lit Property vs Attribute Binding for Dynamic Custom Element | anti-pattern | lit, testing, release, methodology | 2026-05-23 |
| L017 | `window.history` Absent in happy-dom — Mock Per-Test, Not Gl | anti-pattern | testing, release, methodology | 2026-05-23 |
| L018 | `@state()` on Never-Mutated Fields — Speculative Code Invisi | anti-pattern | lit, release, methodology, typescript | 2026-05-23 |
| L019 | GitHub Wiki is a Separate Clonable Git Repo | pattern | release, methodology, github | 2026-05-23 |
| L020 | GitHub Classic PAT — `repo` Scope Required for Releases API, | anti-pattern | release, methodology, github | 2026-05-23 |
| L021 | Large README Anti-Pattern — Split Into Per-Component Docs Ea | pattern | lit, release | 2026-05-23 |
| L022 | XSS Vulnerability in Test DOM Cleanup (OWASP A03) | anti-pattern | lit, testing, release, methodology | 2026-05-24 |
| L023 | Lit Template Ternaries Are Structurally Uncoverable by v8 | anti-pattern | lit, testing, release, methodology | 2026-05-24 |
| L024 | `!= null` vs `!== null && !== undefined` — TypeScript Strict | pattern | lit, release, methodology | 2026-05-24 |
| L025 | Type-Guard Unit Tests Belong in `tests/types/` — Not Inlined | pattern | lit, testing, release, methodology, typescript | 2026-05-24 |
| L026 | Inspect the Branch History Before Building Any Dev Tool | anti-pattern | testing, release, methodology, ha-api, workbench | 2026-05-24 |
| L027 | Production YAML Configs Are the Ideal Source for Mock Data | pattern | testing, release, methodology, ha-api, workbench | 2026-05-24 |
| L028 | ID Selectors on Root Layout Wrappers Override Granular Class | anti-pattern | lit, css, release, methodology, workbench, typescript | 2026-05-24 |
| L029 | Web Components and Container Queries in DOM Simulation | pattern | css, testing, release, ha-api, workbench | 2026-05-24 |
| L030 | SVG-rendered Light DOM Custom Element Sizing & Invisible Ico | pattern | lit, css, release | 2026-05-24 |
| L031 | Promise Caching for Heavy Websocket API Category Fetches | pattern | testing, release | 2026-05-24 |
| L032 | Sibling Lit Property Race Condition & Initialization Updates | pattern | release, ha-api | 2026-05-24 |
| L033 | Custom Element Upgrade Failure due to Style Mutations in Con | anti-pattern | css, release, methodology, ha-api | 2026-05-24 |
| L034 | Shadow DOM :host Selector Custom Property Inheritance | anti-pattern | css, release, ha-api, workbench | 2026-05-24 |
| L039 | Avoid Unsolicited Style Embellishments on Simple Layout Requ | anti-pattern | css, release, methodology | 2026-05-24 |
| L042 | Floor/Area Initial Selection — Validate Existence, Not Conte | anti-pattern | release, methodology, ha-api | 2026-05-24 |
| L043 | Test Selectors Must Match Implementation HTML — Document in  | anti-pattern | css, testing, release, methodology | 2026-05-24 |
| L044 | Bottom-Aligned SVG + Fixed `padding-top` = Fragile Positioni | anti-pattern | css, release | 2026-05-24 |
| L045 | CSS Custom Variable Override vs. `width` on Web Component Ho | anti-pattern | lit, css, release | 2026-05-24 |
| L046 | Downward Dropdown Overflow — `right: 0` Is the Correct Horiz | anti-pattern | release | 2026-05-24 |
| L047 | `overflow-x: hidden` on `:host` Clips Shadow DOM Children | anti-pattern | lit, css, release | 2026-05-24 |
| L048 | Test Coupling to Intermediate Implementation Hooks Breaks On | anti-pattern | testing, release, methodology, ha-api, i18n | 2026-05-24 |
| L049 | ES Module Named Exports Are Read-Only in Vitest — Cannot vi. | anti-pattern | testing, release, ha-api, i18n | 2026-05-24 |
| L051 | Dynamic Localization of Platform-native Fallback Labels in L | pattern | lit, testing, release, i18n | 2026-05-24 |
| L052 | Synchronizing Chart timeline locale with the connected HASS  | pattern | release, ha-api, i18n | 2026-05-24 |
| L053 | Editor UI Labels Must Route Through `getLabel()` — Never Dir | anti-pattern | lit, release, methodology, i18n | 2026-05-24 |
| L054 | DOM Selector Verification Before Writing Editor Tests — Insp | anti-pattern | lit, css, testing, release, methodology | 2026-05-24 |
| L055 | Pure SVG Data Files Must Be Excluded From Coverage — They Ar | anti-pattern | lit, css, testing, release, methodology | 2026-05-24 |
| L057 | CSS Custom Property Circular Self-Reference Is Silently Igno | anti-pattern | lit, css, release, methodology | 2026-05-25 |
| L058 | `rem` Fallbacks in HA Custom Cards Must Be Absolute `px` Val | anti-pattern | css, release, methodology | 2026-05-25 |
| L059 | Lit Custom Element `:host` Requires `display: block` for `ma | anti-pattern | lit, css, release, methodology | 2026-05-25 |
| L060 | lit-localize msg() Source MUST Be English — French Source Ke | anti-pattern | lit, testing, release, methodology, i18n | 2026-05-25 |
| L061 | Shadow DOM Height Propagation — `height:100%` Must Chain Fro | anti-pattern | lit, css, release, methodology | 2026-05-25 |
| L062 | `sf-landspeeder` Sizing — flex:1 + height:100% Enables Adapt | pattern | css, release, methodology | 2026-05-25 |
| L063 | `noUncheckedIndexedAccess` — Always Use Non-Null Assertion o | anti-pattern | testing, release, methodology, typescript | 2026-05-25 |
| L064 | External HA Interface Types Must Match the Full Runtime Obje | anti-pattern | release, methodology, ha-api, typescript | 2026-05-25 |
| L065 | CSS Custom Property Double-Dash Typo Is Silently Ignored | anti-pattern | css, release, methodology, typescript | 2026-05-25 |
| L066 | HA CORS Must Match Workbench Exact Origin (Protocol + Hostna | anti-pattern | release, methodology, ha-api, workbench | 2026-05-25 |
| L067 | Workbench Card Config Must Be Derived From Real YAML — Never | anti-pattern | testing, release, methodology, workbench | 2026-05-25 |
| L068 | sf-toast Component Was Never Ported to TypeScript v2 — Silen | anti-pattern | lit, release, methodology, typescript | 2026-05-25 |
| L069 | Workbench i18n — setLocale Must Be Called Directly, Not Via  | anti-pattern | lit, release, methodology, ha-api, workbench, i18n | 2026-05-25 |
| L070 | Lit Toggle Selector Ambiguity — Multiple `sf-toggle-switch`  | anti-pattern | lit, css, testing, release, methodology | 2026-05-25 |
| L071 | Dynamic `element-id` Attributes on Dropdown Entities — Use M | anti-pattern | lit, testing, release, methodology, typescript | 2026-05-25 |
| L072 | Decouple Selection Styles from Child Component Domain-State  | anti-pattern | css, testing, release | 2026-05-25 |
| L097 | `ha-card` Is `display: block` — Must Be Overridden for Flex  | anti-pattern | lit, css, release, methodology, ha-api | 2026-05-25 |
| L098 | OAuth Auth Callback From Localhost — PKCE Verifier Must Be C | anti-pattern | release, workbench | 2026-05-25 |
| L099 | Battery Warning Color Pattern — Threshold Classes vs Inline  | pattern | css, release, methodology, typescript | 2026-05-25 |
| L100 | Flex Height Chain in Lit Custom Elements — `:host` Must Be ` | anti-pattern | lit, css, release, methodology, ha-api | 2026-05-25 |
| L101 | `min()` as Upper Bound for Absolute-Positioned Indicators on | anti-pattern | css, release, methodology | 2026-05-25 |
| L102 | Vitest Chai Assertions — Avoid Non-Existent `toBeA` | anti-pattern | css, testing, release, typescript | 2026-05-25 |
| L103 | Stale Locked Test Files in Additive `.tdd_lock` | pattern | testing, release, methodology | 2026-05-25 |
| L104 | Test Quality Check (P9) and Dynamic/Side-Effect Imports Supp | pattern | lit, testing, release, methodology | 2026-05-25 |
| L105 | Sentrux Base Registry Exception in God Files Constraint | pattern | methodology | 2026-05-25 |
| L106 | Switching to Attribute Binding for Static Web Component Prop | pattern | lit, css, release, methodology | 2026-05-29 |
| L107 | Lit Object to String Conversion Bug (`[object Object]`) | anti-pattern | lit, release |  |
| L073 | lit-localize Extract Silently Fails to Update Target Builds  | anti-pattern | lit, release, methodology, i18n |  |
| L074 | Home Assistant `hass.floors` Initialization Race Condition E | anti-pattern | release, ha-api |  |
| L075 | Terser Minification Collapses lit-localize Ternary Expressio | anti-pattern | lit, release, i18n |  |
| L076 | Declarative Data Objects vs. Functions for Scenario/Config R | anti-pattern | lit, release, methodology, workbench, typescript |  |
| L077 | Prefer ID Selectors Over CSS Class Selectors for Event Liste | anti-pattern | lit, css, release, methodology, workbench |  |
| L078 | Workbench Editor Breaks After Config Update When `scenarioDa | anti-pattern | testing, release, methodology, ha-api, workbench, i18n |  |
| L079 | happy-dom Clamps `input[type=range]` Invalid Values — Test N | anti-pattern | lit, testing, release, methodology |  |
| L080 | Spec Drift Accumulates Silently When Editor Components Are M | anti-pattern | release, methodology |  |
| L081 | Mock Hass States Missing `entity_id` Property Causes Editor  | anti-pattern | lit, testing, release, methodology, ha-api, workbench |  |
| L082 | GUI Editor Tab Switch Does Not Remount Editor When Panel Was | anti-pattern | release, methodology, workbench |  |
| L083 | `getLabel()` Returns Empty String Silently for Unknown Keys  | anti-pattern | testing, release, methodology, workbench, i18n, typescript |  |
| L084 | `msg('string_fr')` as EN Source Creates Locale Lock — Editor | anti-pattern | lit, release, methodology, i18n |  |
| L085 | Eliminating Custom Redundant Config Keys in Favor of Generic | anti-pattern | testing, release, methodology, typescript |  |
| L086 | HA Hybrid TV Entities — Hardware + Cast Dual Entity Pattern | anti-pattern | release, typescript |  |
| L087 | i18n + HMR Double Registration and TypeScript Resolution Con | pattern | lit, release, workbench, i18n, typescript |  |
| L088 | HA Service Domain Inference — Never Hardcode Domain from Ent | anti-pattern | lit, release, ha-api, typescript |  |
| L089 | Hexa-Tiles Unsupported Domains — Use HA Backend Aggregation | anti-pattern | release, ha-api |  |
| L090 | HA Scoped Custom Element Registry — Global define Patch Must | anti-pattern | release, methodology, ha-api, workbench | 2026-06-02 |
| L091 | Rollup compile-time constants must be mirrored in vitest.con | pattern | testing, release, typescript | 2026-06-02 |
| L092 | GitHub release body must be verbatim from CHANGELOG.md — nev | anti-pattern | release, github | 2026-06-02 |
| L093 | GitHub release title = thematic name from Release-plan.md, n | pattern | release, github | 2026-06-02 |
| L094 | Tag convention — NO 'v' prefix. Tags are bare X.Y.Z. | pattern | release, methodology, github | 2026-06-02 |
| L095 | Subagent "HIGH confidence" conclusions are Untrusted — alway | anti-pattern | release, methodology | 2026-06-02 |
| L096 | "X only" instruction = hard stop after X — never chain the n | anti-pattern | release, methodology, github | 2026-06-02 |
...
### L097: `ha-card` Is `display: block` — Must Be Overridden for Flex Layout Children
**Date**: 2026-05-25
...
### L098: OAuth Auth Callback From Localhost — PKCE Verifier Must Be Consumed Immediately
**Date**: 2026-05-25
...
### L099: Battery Warning Color Pattern — Threshold Classes vs Inline Style
**Date**: 2026-05-25
...
### L100: Flex Height Chain in Lit Custom Elements — `:host` Must Be `display:flex` for `ha-card{flex:1}` to Work
**Date**: 2026-05-25
...
### L101: `min()` as Upper Bound for Absolute-Positioned Indicators on Variable-Height SVG Containers
**Date**: 2026-05-25
...
### L102: Vitest Chai Assertions — Avoid Non-Existent `toBeA`
**Date**: 2026-05-25
...
### L103: Stale Locked Test Files in Additive `.tdd_lock`
**Date**: 2026-05-25
...
### L104: Test Quality Check (P9) and Dynamic/Side-Effect Imports Support
**Date**: 2026-05-25
...
### L105: Sentrux Base Registry Exception in God Files Constraint
**Date**: 2026-05-25
...
### L106: Switching to Attribute Binding for Static Web Component Properties and Scaling Hexagonal Honeycomb Grids
**Date**: 2026-05-29
...
### L107: Lit Object to String Conversion Bug (`[object Object]`)
**Date:** 2026-05-29
...
### L076: Declarative Data Objects vs. Functions for Scenario/Config Registries
**Date:** 2026-05-30
**Source:** ha-sci-fi — workbench modular refactoring
**Evidence:** During the monolith split (2819 lines → 22 files), subagent generated `card.scenarios[key]()` (function call) instead of `card.scenarios[key]` (data access), because the original monolith used factory functions for scenarios. The new architecture exported pure data objects. Bug caught during post-merge review — `TypeError: ... is not a function`.
**Anti-pattern:** When refactoring from inline functions to declarative data exports, the calling code retains the old function-call convention (`()`) because the subagent saw the original pattern in context. The type system (plain JS, no TypeScript) cannot catch this — both `obj.key()` and `obj.key` are valid syntax.
**Fix:** When a refactoring changes the contract from "functions returning data" to "pure data objects", explicitly document the calling convention change in the refactoring spec: `scenarios[key]` NOT `scenarios[key]()`. In untyped JS codebases, add a comment at the registry export: `// scenarios are plain objects, NOT factories — do not call them`. Better: use TypeScript or JSDoc `@type` annotations to make the contract machine-checkable.

### L077: Prefer ID Selectors Over CSS Class Selectors for Event Listener Binding
**Date:** 2026-05-30
**Source:** ha-sci-fi — workbench modular refactoring
...
### L092: GitHub release body must be verbatim from CHANGELOG.md — never rewritten
**Date**: 2026-06-02
**Source**: ha-sci-fi v1.3.1 release — body reconstruction error
**Evidence**: Agent generated release body from memory, adding "# v1.3.1 + v1.3.0 — Bridge Overview 🛸🎛️\n\n---" header and paraphrasing changelog text. User caught the discrepancy immediately.
**Anti-pattern**: Reconstructing or paraphrasing the CHANGELOG for a GitHub release body. Any fabricated header, separator, or reworded bullet is a violation.
**Correct pattern**: Extract verbatim with `BODY=$(sed -n '<start>,<end>p' CHANGELOG.md)` and pass `$BODY` directly to the API via `jq --arg body "$BODY"`. No post-processing. The CHANGELOG is the source of truth — the release body IS the changelog, nothing else.

### L093: GitHub release title = thematic name from Release-plan.md, not version description
**Date**: 2026-06-02
**Source**: ha-sci-fi v1.3.1 release — "Registry Fix" title error
**Evidence**: Agent titled the release "v1.3.1 — Registry Fix" (descriptive of this patch's content). User rule: title must always be the milestone thematic name from Release-plan.md.
**Correct pattern**:
- Major/minor (`X.Y.0`): title = exact thematic name + icons from Release-plan.md line (e.g. "Bridge Overview 🛸🎛️")
- Patch (`X.Y.Z`, Z>0): title = same as parent X.Y.0 thematic name
- Step: `grep "X.Y" ../ha-sci-fi-wiki/Release-plan.md` to extract the name before calling the API.

### L094: Tag convention — NO 'v' prefix. Tags are bare X.Y.Z.
**Date**: 2026-06-02
**Source**: ha-sci-fi v1.3.1 — wrong tag v1.3.1 created instead of 1.3.1
**Evidence**: All existing tags (1.2.2, 1.2.3, 1.2.4, 1.3.0) use bare X.Y.Z without 'v'. Agent created 'v1.3.1' breaking the convention. User had to delete the release and tag manually.
**Correct pattern**: `git tag X.Y.Z` (never `git tag vX.Y.Z`). GitHub API `tag_name` = `"X.Y.Z"` (never `"vX.Y.Z"`). Before tagging, always run `git tag | tail -3` to verify the convention of existing tags in the repo.

### L095: Subagent "HIGH confidence" conclusions are Untrusted — always cross-check against source
**Date**: 2026-06-02
**Source**: ha-sci-fi v1.3.2 — card picker DISCOVER phase
**Evidence**: Research subagent concluded with "HIGH confidence" that the card picker bug was already fixed by the `__DEV__` guard introduced in v1.3.1. This was entirely wrong — the real root cause (double `custom:` prefix in `window.customCards`) was independent and had existed since v1.0.0. The correct fix was identified by reading the source code directly (`src/sci-fi.ts:161`), not from the subagent report.
**Anti-pattern**: Treating subagent output as Trusted. Subagents can synthesize false conclusions with high stated confidence, especially when they reason from indirect evidence (code flow inference) rather than reading the actual data path.
**Fix**: Apply the same trust level to subagent conclusions as to external API responses — **Verify-first**. Before acting on a subagent's root-cause conclusion, read the relevant source lines yourself. "HIGH confidence" from a subagent is not evidence.

### L096: "X only" instruction = hard stop after X — never chain the natural next step
**Date**: 2026-06-02
**Source**: ha-sci-fi v1.3.2 HARDEN — scope overrun
**Evidence**: User said "go harden only". After completing doc-update + refactor-clean + commit, agent continued into version bump, CHANGELOG, git tag, git push, and attempted GitHub release creation. User had to explicitly say "tu me vires le tag" to undo. The tag had already been pushed to origin.
**Anti-pattern**: Interpreting "go X only" as "go X, then proceed to X+1 since it's the logical continuation". The "only" qualifier is a hard stop, not a soft suggestion.
**Fix**: When an instruction contains "only", "just", or a specific stage name, execute exactly that stage and stop. Write a one-line summary of what was done and wait. Never infer authorization for subsequent steps from the natural pipeline order.

### L108: `self` Subagent Does Not Inherit Parent's Pre-Granted Write Permissions
**Date**: 2026-06-02 | **Tags**: methodology, testing
**Source**: ha-sci-fi — learnings.md optimization session
**Evidence**: Parent agent had `write_file(.agents/learnings.md)` pre-granted by user policy. Spawned `self`-type subagent to rewrite the file. Subagent blocked on `write_file` permission request for 8 minutes before being killed — it could read but not write. Switch to direct Python script completed the same task in ~10 seconds.
**Anti-pattern**: Delegating large file rewrite tasks to a `self` subagent assuming it inherits the parent's runtime permission grants. Permission grants in Antigravity are conversation-scoped to the spawning agent, not inherited by subagents.
**Fix**: For tasks that require writing to pre-granted paths, execute directly in the parent agent. Reserve subagents for read-only research or for tasks where the subagent will request permissions independently. If a subagent must write, explicitly confirm it will request the needed permission at runtime.

### L109: Large File Rewrites (>200 lines) = Python script, not subagent or multi_replace
**Date**: 2026-06-02 | **Tags**: methodology, typescript
